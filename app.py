...
st.set_page_config(page_title="Phonepe Pulse Data Visualization | By Prajwal",
                   page_icon=icon,
                   layout="wide",
                   initial_sidebar_state="expanded",
                   menu_items={'About': """# This dashboard app is created by *Prajwal*!
...
if selected == "Home":
    ...
    with col1:
        ...
        st.markdown(
            "### :red[Technologies used :] Github Cloning, Python, Pandas, MySQL, mysql-connector-python, Streamlit, and Plotly.")
        st.markdown(
            "### :red[Overview :] In this streamlit web app you can visualize the phonepe pulse data and gain lot of insights on transactions, number of users, top 10 state, district, pincode and which brand has most number of users and so on. Bar charts, Pie charts and Geo map visualization are used to get some insights.")
    with col2:
        st.image("home.png")
...
if selected == "About":
    ...
    with col1:
        ...
        st.write(
            "##### PhonePe is an Indian digital payments platform that allows users to transfer money, pay bills, recharge mobile phones, and make online purchases conveniently. It was founded in 2015 and has gained popularity in India due to its user-friendly interface and seamless transactions")
